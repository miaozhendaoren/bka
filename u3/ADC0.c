...
void ADC0_vInit(void)
{
  ...
  ADC0_CLC       =  0x0000003C;  // load ADC0 clock control configuration 
                                 // register
  uwTemp         = ADC0_CLC; // dummy read to avoid pipeline effects
  ...
  ///  - the ADC module clock = 90,00 MHz
  ///   
  ...
  ADC0_INPCR0    =  0x00000100;  // load input class0 register
  ...
  ///  -----------------------------------------------------------------------
  ADC0_SYNCTR   |=  0x00000000;  // Synchronisation register
...
//****************************************************************************
// @Function      void ADC0_vStartSeq2ReqChNum(ubyte ubExtTrg, ubyte ubEnIntr, ubyte ubRFill, ubyte ubChannelNum) 
//
//----------------------------------------------------------------------------
// @Description   This function starts the conversion of the requested 
//                channel.
...
//****************************************************************************
// @Function      void ADC0_vStartSeq4ReqChNum(ubyte ubExtTrg, ubyte ubEnIntr, ubyte ubRFill, ubyte ubChannelNum) 
//
//----------------------------------------------------------------------------
// @Description   This function starts the conversion of the requested 
//                channel.
//                NOTE -
//                Before passing ubEnIntr argument as 1,make sure that Seq 4 
//                source interrupt is enabled.
//                External Trigger -> 0,Indicates software trigger 
//                (Conversion starts once this function is executed)
//
...
void ADC0_vStartSeq4ReqChNum(ubyte ubExtTrg, ubyte ubEnIntr, ubyte ubRFill, ubyte ubChannelNum)
{
  ...
  ADC0_QINR4 = uwVal; // requested channel 

} //  End of function ADC0_vStartSeq2ReqChNum


//****************************************************************************
// @Function      void ADC0_vStartParReqChNum(uword uwChannelNum, ubyte ubSrc) 
//
//----------------------------------------------------------------------------
...
//                conversion 
//                Ex- ubSrc = ADC0_SOURCE_1,for parallel source 1
//                    ubSrc = ADC0_SOURCE_3,for parallel source 3
//
//----------------------------------------------------------------------------
// @Returnvalue   None
//
...
void ADC0_vStartParReqChNum(uword uwChannelNum, ubyte ubSrc)
{
      ...
      {
         ADC0_CRCR3      |=  uwChannelNum; // requested channel
...
//****************************************************************************
// @Function      void ADC0_vClearPendingBits(ubyte ubSourceNum) 
//
//----------------------------------------------------------------------------
// @Description   This function clears all the pending requests for the 
//                corresponding source.
//                ubSourceNum -> ADC0_SOURCE_0,indicates seq 0 source
//                ubSourceNum -> ADC0_SOURCE_1,indicates parallel source 1
//                ubSourceNum -> ADC0_SOURCE_2,indicates seq 2 source
//                ubSourceNum -> ADC0_SOURCE_3,indicates parallel source 3
//                ubSourceNum -> ADC0_SOURCE_4,indicates seq 4 source 
//
//----------------------------------------------------------------------------
// @Returnvalue   None
//
//----------------------------------------------------------------------------
// @Parameters    ubSourceNum: 
//                SourceNumber : Source Number for which pending bits have to 
//                be cleared.
//
//----------------------------------------------------------------------------
// @Date          21.03.2012
...
void ADC0_vClearPendingBits(ubyte ubSourceNum)
{
      ...
      if(ubSourceNum == 0) 
      {
            ADC0_QMR0 |= 0x00000100;    // Clear sequential source 0 pending bits

      }
      else if(ubSourceNum == 1) 
      {
            ADC0_CRMR1 |= 0x00000100;    // Clear parallel source 1 pending bits

      }
      else if(ubSourceNum == 2) 
      {
            ADC0_QMR2 |= 0x00000100;    // Clear sequential source 2 pending bits

      }
      else if(ubSourceNum == 3) 
      {
            ADC0_CRMR3 |= 0x00000100;    // Clear parallel source 3 pending bits

      }
      else  
      {
         ADC0_QMR4       |=  0x00000100;  // Clear sequential source 4 pending bits 

      }

} //  End of function ADC0_vClearPendingBits
